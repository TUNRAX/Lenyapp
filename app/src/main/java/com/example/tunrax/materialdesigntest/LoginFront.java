            ...
            public void onClick(View v) {
                ...
                if(thread1.getState()!=Thread.State.TERMINATED){
                    ...
                    if (user.equals("") || pass.equals("")) {
                        ...
                        String url1 = "http://ab70d881.ngrok.io/login.php";
                        try {
                                    ...
                                    try {
                                        ...
                                        if (user.equals(correoInterno) && passEncriptada.equals(contrasenya)) {
                                            ...
                                            if (loginOk) {
                                                ...
                                                String url2 = "http://ab70d881.ngrok.io/ListaProveedores.php";
                                                try {
   ...
   /* public void onButtonPressed(Uri uri) {
    ...
    public String Check(String user, String pass) {
        ...
        try {
            ...
            url = new URL("http://ab70d881.ngrok.io/checkearRol.php?correo=" + user
                    + "&contrasenya=" + pass);
