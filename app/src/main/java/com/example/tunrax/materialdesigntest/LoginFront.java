            ...
            public void onClick(View v) {
                ...
                if(thread1.getState()!=Thread.State.TERMINATED){
                    ...
                    if (user.equals("") || pass.equals("")) {
                        ...
                        String url1 = "http://7a144ad2.ngrok.io/login.php";
                        try {
                                    ...
                                    try {
                                        ...
                                        if (user.equals(correoInterno) && pass.equals(contrasenya)) {
                                            ...
                                            if (loginOk) {
                                                ...
                                                String url2 = "http://7a144ad2.ngrok.io/ListaProveedores.php";
                                                try {
   ...
   /* public void onButtonPressed(Uri uri) {
    ...
    public String Check(String user, String pass) {
        ...
        try {
            ...
            url = new URL("http://7a144ad2.ngrok.io/checkearRol.php?correo=" + user
                    + "&contrasenya=" + pass);
