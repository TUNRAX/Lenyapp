...
public class FavoritoActivity extends AppCompatActivity {
    ...
    public String Proveedores(int id) {
        ...
        try {
            ...
            url = new URL("http://84361097.ngrok.io/obtenerListaFavoritos.php?idUsuario=" + id);
    ...
    public void Calificacion(int idUsuario, int idProveedor) {
        ...
        try {
            ...
            url = ("http://84361097.ngrok.io/calificacion.php?idUsuario=" + idUsuario
    ...
    public String verificarCalificacion(int idUsuario, int idProveedor) {
        ...
        try {
            ...
            url = ("http://84361097.ngrok.io/verificarCalificacion.php?idUsuario=" + idUsuario
                    + "&idProveedor=" + idProveedor);
            url = url.replaceAll(" ", "%20");
            URL sourceUrl = new URL(url);
            HttpURLConnection connection = (HttpURLConnection) sourceUrl.openConnection();
    ...
    public void eliminarCalificacion(int idUsuario, int idProveedor) {
        ...
        try {
            ...
            url = ("http://84361097.ngrok.io/eliminarCalificacion.php?idUsuario=" + idUsuario
                    + "&idProveedor=" + idProveedor);
            url = url.replaceAll(" ", "%20");
            URL sourceUrl = new URL(url);
            HttpURLConnection connection = (HttpURLConnection) sourceUrl.openConnection();
