...
/**
 * esta activity añade los leñadores favoritos que tiene el usuario
 * al ir presionando el boton de favoritos en la pagina del leñador
 * se añadira a esta activity (TODO)
 */
...
public class FavoritoActivity extends AppCompatActivity {
    ...
    private TableLayout tblFavorito;
    int idUsu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tblFavorito = (TableLayout) findViewById(R.id.tblFavorito);
        ...
        params1.setMargins(12,0,0,0);
        params2.setMargins(12,0,0,0);
                    ...
                    public void run() {
                        try {
                            ...
                            for (int i = 0; i < listaProveedor.size(); i++) {
                                TableRow row = new TableRow(FavoritoActivity.this);
                                final ArrayList<Calificacion> listaCalificacion = new ArrayList<Calificacion>();
                                TextView lblNombreLeñador = new TextView(FavoritoActivity.this);
                                TextView lblDireccionLeñador = new TextView(FavoritoActivity.this);
                                ...
                                final ImageView btnLike = new ImageButton(FavoritoActivity.this);
                                                    ...
                                                    try {
                                                        ...
                                                        runOnUiThread(new Runnable() {
                                                            ...
                                                            public void run() {
                                                                btnLike.setImageResource(R.drawable.likewhitemini);
                                                                btnLike.setTag(R.drawable.likewhitemini);
                                                                Toast.makeText(FavoritoActivity.this, "descalificacion realizada", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    } catch (Exception e) {
                                                        Log.e("app", "exception", e);
                                                    ...
                                                    try {
                                                        ...
                                                        runOnUiThread(new Runnable() {
                                                            ...
                                                            public void run() {
                                                                btnLike.setImageResource(R.drawable.likeblackmini);
                                                                btnLike.setTag(R.drawable.likeblackmini);
                                                                Toast.makeText(FavoritoActivity.this, "Gracias por calificar", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    } catch (Exception e) {
                                                        Log.e("app", "exception", e);
                        ...
                        try {
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(FavoritoActivity.this, "Error Volley", Toast.LENGTH_SHORT).show();
                                }
                            });
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        switch (which) {
                                            case DialogInterface.BUTTON_POSITIVE:
                                                progressDoalog[0] = new ProgressDialog(FavoritoActivity.this);
                                                    ...
                                                    public void run() {
                                                        try {
                                                            ...
                                                            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                                                                ...
                                                                @Override
                                                                public void onErrorResponse(VolleyError error) {
                                                                    Toast.makeText(FavoritoActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                                                }
                                                            });
                                                            ...
                                                            if (verificado[0] == 4) {
                                                                Toast.makeText(FavoritoActivity.this, "Redireccionando", Toast.LENGTH_SHORT).show();
                                                                SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
                                                                editor.putString("idHistorial", String.valueOf(idHistorial[0]));
                                                                editor.apply();


                                                                Intent i = new Intent(FavoritoActivity.this, MapsActivity2.class);
                                                                ...
                                                                Toast.makeText(FavoritoActivity.this, "Leñador no disponible", Toast.LENGTH_LONG).show();
                                                                progressDoalog[0].dismiss();
                                                                finalizar[0] = 1;
                                                                checkearPedidos(idUsu);
    ...
    public String Proveedores(int id) {
        ...
        try {
            ...
            url = new URL("http://e9eec324.ngrok.io/obtenerListaFavoritos.php?idUsuario=" + id);
