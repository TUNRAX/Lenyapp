...
public class tipoCompra implements Parcelable {
    private int id;
    private String nombre;

    public tipoCompra(int id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    protected tipoCompra(Parcel in) {
        id = in.readInt();
        nombre = in.readString();
    }

    public tipoCompra(JSONObject objetoJSON)throws JSONException {
